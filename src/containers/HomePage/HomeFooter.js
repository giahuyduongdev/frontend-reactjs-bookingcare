      ...
      <div className="home-footer">
        ...
        <div class="content-right">
          <div className="content-right text3">
            <a href="https://www.tiktok.com/@bookingcare.sktd" target="_blank">
          ...
          <div className="content-right text1">
            <a href="https://www.facebook.com/bookingcare" target="_blank">
          ...
          <div className="content-right text2">
            <a href="https://www.youtube.com/channel/UC9l2RhMEPCIgDyGCH8ijtPQ" target="_blank">
