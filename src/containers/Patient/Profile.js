...
const Profile = ({ isVisible, onCancel, data, onSave }) => {
  ...
  const avatarUrl = data.image && data.image.data
    ...
    if(data.image){
      ...
      imageBase64 = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPUPPObe8bkov6CluwLDx5FNgla0wkgvJxAgPhrGxg_ZcXu36M1nBLZDnHfRyltQNjZVw4VROMhokT0D4mTrQ57g";
    }
        ...
        <Col xs={24} sm={18}>
          <Descriptions bordered column={1}>
            ...
            <Descriptions.Item label="Giới tính">
              {editedData.gender === 'M' ? 'Male' : editedData.gender === 'F' ? 'Female' : 'Other'}
            </Descriptions.Item>
          </Descriptions>
